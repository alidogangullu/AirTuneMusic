            ...
            <View style={[styles.adHintContainer, styles.adHintContainerFirst, { flexDirection: 'row', alignItems: 'center', gap: spacing.lg }]}>
              ...
              <View style={{ flex: 1, paddingLeft: spacing.md, marginTop: 4 }}>
                <Text style={[styles.adHintText, { fontSize: 11, lineHeight: 15, fontStyle: 'italic', textAlign: 'center' }]}>
                  {(t('settings.pro.disclaimer') || "Kaset is an independent Apple Music client, not an official Apple app. Upgrading to Pro removes Kaset's playback and streaming limits and supports development. This purchase is separate from your Apple Music subscription.").replace(/\n/g, ' ')}
                </Text>
              </View>
            </View>
          )}
      ...
      <View style={styles.container}>
        ...
        <View style={styles.columns}>
          <View style={styles.leftColumn}>
            ...
            <Text style={styles.appNameText}>Kaset for Apple Music</Text>
          </View>
